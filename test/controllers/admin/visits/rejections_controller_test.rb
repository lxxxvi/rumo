...
class Admin::Visits::RejectionsControllerTest < ActionDispatch::IntegrationTest
  setup do
    @host = hosts(:cafe)
  ...
  test 'post create' do
    ...
    assert_difference -> { Visit.count }, -1 do
      post admin_visit_rejection_path(@visit)
  ...
  test 'cannot post create, if visit belongs to another host' do
    ...
    assert_raises ActiveRecord::RecordNotFound do
      post admin_visit_rejection_path(foreign_visit)
    end
  end
